def emailTemplate(name, link, passT):
    return """
        <!DOCTYPE html>
														...
														<tr>
															<td class="pad"
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 14px; font-family: Varela Round, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 16.8px; color: #ffffff; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
																			<span style="font-size:30px;text-transform: capitalize;">"""+passT+""" Your
																				Password</span></p>
																	</div>
																</div>
															</td>
													...
													<table border="0" cellpadding="5" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 14px; font-family: Varela Round, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 21px; color: #ffffff; line-height: 1.5;">
																		...
																		<p
																			...
																			We received a request to """+passT+""" your
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="""+link+""" style="height:40px;width:197px;v-text-anchor:middle;" arcsize="60%" stroke="false" fillcolor="#ffffff"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#091548; font-family:sans-serif; font-size:15px"><![endif]--><a
																		href="""+link+"""
																		...
																		target="_blank"><span
																			style="padding-left:25px;padding-right:25px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
																				style="word-break:break-word;"><span
																					data-mce-style=""
																					style="line-height: 30px; text-transform: uppercase;"><strong>"""+passT+"""
																						MY
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 14px; font-family: Varela Round, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 21px; color: #7f96ef; line-height: 1.5;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
