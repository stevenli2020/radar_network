...
def parseStandardFrame(frameData):
    ...
    outputDict['error'] = 0
    # print("\r-----------------------------------------")
    # print(''.join(format(x, '02X') for x in frameData))
    # print("\r-----------------------------------------")
    try:
    ...
    for i in range(numTLVs):
        ...
        # Target Height
            ...
            outputDict['trackHeight'] = parseTargetHeightTLV(frameData[:tlvLength], tlvLength)
