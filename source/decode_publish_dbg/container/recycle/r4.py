...
def decode_process_publish(mac, data):
        ...
        if len(byteAD) > 52:
            ...
            if radarType == 'wall':
                ...
                if wallStateParam[mac]['pandasDF'].empty:
                    ...
                    print("XXXXXXXXXX")
                    aggregate_dict = {}
                    aggregate_dict['timeStamp'] = wallStateParam[mac]['pandasDF']['timeStamp'].mean(skipna=True)
    ...
    if len(pubPayload["DATA"]) > 0:
        ...
        if radarType == 'wall':
            ...
            mqttc.publish("/GMT/DEV/"+mac+"/DATA/WALL/JSON2", jsonData)
        elif radarType == 'ceil':
            pubPayload["TYPE"]="CEIL"
            jsonData = json.dumps(pubPayload)        
            mqttc.publish("/GMT/DEV/" + mac + "/DATA/CEIL/JSON2", jsonData)
        elif radarType == 'vital':
            pubPayload["TYPE"]="VITAL"
            jsonData = json.dumps(pubPayload)        
            mqttc.publish("/GMT/DEV/" + mac + "/DATA/VITAL/JSON2", jsonData)
        # print(jsonData)
        # print("\n%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n")              
        time.sleep(0.1)
...
print("Subscribe to topic: "+ "/GMT/DEV/F412FAE2620C/DATA/+/RAW/#")
mqttc.subscribe("/GMT/DEV/F412FAE2620C/DATA/+/RAW/#")
# print("Subscribe to topic: "+ "/GMT/DEV/F412FAE26208/DATA/+/RAW/#")
# mqttc.subscribe("/GMT/DEV/F412FAE26208/DATA/+/RAW/#")
# print("Subscribe to topic: "+ "/GMT/DEV/F412FAE261A4/DATA/VITAL/RAW")
# mqttc.subscribe("/GMT/DEV/F412FAE261A4/DATA/VITAL/RAW")
# mqttc.publish("/GMT/USVC/DEBUG/STATUS","CONNECTED",1, False)
time.sleep(1)
