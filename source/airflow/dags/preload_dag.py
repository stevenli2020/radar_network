...
import constants
from constants import config, vernemq
...
def check_servers():
    ...
    if not ui_status or not api_status:
        ...
        """
        sentMail(recipients, constants.SERVER_NAME + " Servers Disconnected!", body)
...
def check_disconnected_devices():
    ...
    if len(result) > 0:
        ...
        sentMail(recipients, constants.SERVER_NAME + " Devices Disconnected!", body)
